...
document.querySelectorAll('.side-item a').forEach((link, index) => {
    const pages = ['dashboard.html', 'novo_chamado.html', 'chamados.html', 'contratos.html', 'atendimento.html', 'Relatorios.html', 'contratos.html'];
